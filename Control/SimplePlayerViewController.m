...
#define testUrl [NSURL URLWithString:@"http://192.168.0.6:8080/VRMobileServer/video/balidao_HD.mp4"]
...
//    [self createAssetWithUrl:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"巴厘岛短片" ofType:@"mp4"]]];
    
    [self createAssetWithUrl:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"PAN01" ofType:@"mp4"]]];
...
- (void)startPlayVideo {
    ...
    // create a Panframe asset
        NSURL *url = testUrl;
         [self createAssetWithUrl:url];
//    [self createAssetWithUrl:[NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:_mp4UrlStr ofType:@"mp4"]]];
